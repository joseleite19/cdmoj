...
imagem no editor web). Regras de nome e tamanho no [PACOTE](PACOTE.md). **Grafo** desenhado a partir
de DOT: `mojtools/docs/enunciado-grafos.md`.
...
fórmula, delimitadores, caracteres de sintaxe, relação sem operando). A coluna **PDF** desta página
